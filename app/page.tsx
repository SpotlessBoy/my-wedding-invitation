      ...
      <AnimatePresence>
        {showMapImage && (
          ...
          >
            ...
            >
              <Image
                src="/images/way_to_hall.jpg" /* 👈 미리 준비하신 약도 이미지 파일명으로 꼭 변경해 주세요! */
                alt="오시는 길 약도"
                fill
                // object-contain을 써서 원본 약도가 잘리지 않고 다 보이게 합니다.
