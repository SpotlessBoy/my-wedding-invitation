      ...
      <div className="max-w-[480px] mx-auto bg-white shadow-[0_0_20px_rgba(0,0,0,0.05)] relative z-10 min-h-screen">
        ...
        <section className="relative z-10 -mt-px py-24 px-8 text-center bg-[#FAFAFA]">
          <FadeIn>
            ...
            >
              <Image
                src="/images/sub_main3_v1.jpg" /* 👈 준비하신 가로형 스냅 사진 파일명으로 변경하세요 */
                alt="lovers"
                fill
      ...
      <div className="mt-12 w-full">
        ...
        <section className="relative z-10 -mt-px py-24 px-8 text-center bg-[#FAFAFA]">
          <FadeIn>
			...
			{/* 👇 수정된 주차 안내 박스 (가운데 정렬 & 양쪽 기둥) 👇 */}
            <div className="mt-8 p-6 bg-white rounded-xl border border-gray-200 shadow-[0_2px_8px_rgba(0,0,0,0.02)] text-center">
              <h3 className="font-bold text-gray-800 text-[15px] mb-3 flex items-center justify-center gap-2">
                <div className="w-1.5 h-3.5 bg-rose-400 rounded-full" />
                예식장 주차안내
                <div className="w-1.5 h-3.5 bg-rose-400 rounded-full" />
              </h3>
              <p className="text-[14px] text-gray-600 leading-[1.7] break-keep mb-4">
                호텔 지하 2층 ~ 지하 4층 <span className="text-rose-500 font-medium whitespace-nowrap">무료 주차 가능</span><br />
                * 만차 시 외부 엑스코 주차장 안내
              </p>
              <div className="bg-gray-50 p-3.5 rounded-lg text-[13px] text-gray-500 leading-[1.6] border border-gray-100">
                ...
                축의대 및 안내데스크의 <span className="text-gray-700 font-medium whitespace-nowrap">QR코드로<br />차량 등록</span>하셔야 2시간 무료주차 적용
              </div>
            </div>
            {/* 👆 주차 안내 박스 끝 👆 */}		
                    ...
                    <div className="p-6 flex flex-col gap-1">
                      ...
                      <div className="flex justify-between items-center border-b border-gray-100 pb-4 mb-4">
                        <div>
                          ...
                          <p className="font-medium text-gray-800 tracking-wide">771-02-007763 <br />농협은행  박주득</p>
                        </div>
                        <button 
                          onClick={() => handleCopy('77102007763')}
                          className="shrink-0 flex items-center gap-1.5 text-[12px] bg-white border border-gray-200 px-3 py-1.5 rounded-md hover:bg-gray-50 text-gray-600 active:scale-95 transition-transform"
                        >
                          <Copy size={14} /> 복사
                        </button>
                      ...
                      <div className="flex justify-between items-center border-b border-gray-100 pb-4 mb-4">
                        <div>
                          ...
                          <p className="font-medium text-gray-800 tracking-wide">757-02-197965 <br />농협은행  서정남</p>
                        </div>
                        <button 
                          onClick={() => handleCopy('75702197965')}
                          className="shrink-0 flex items-center gap-1.5 text-[12px] bg-white border border-gray-200 px-3 py-1.5 rounded-md hover:bg-gray-50 text-gray-600 active:scale-95 transition-transform"
                        >
                          <Copy size={14} /> 복사
                        </button>
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <p className="font-medium text-gray-800 tracking-wide">158-910310-60307 <br />하나은행  박진솔</p>
                        </div>
                        <button 
                          onClick={() => handleCopy('15891031060307')}
                          className="shrink-0 flex items-center gap-1.5 text-[12px] bg-white border border-gray-200 px-3 py-1.5 rounded-md hover:bg-gray-50 text-gray-600 active:scale-95 transition-transform"
                        >
                          <Copy size={14} /> 복사
                        </button>
